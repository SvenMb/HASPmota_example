...
class lv_sp1 : lv.btn
  ...
  def init(parent)
    ...
    # self.set_width(parent.get_width())
    # print("W: ",parent.get_width()," ",self.get_width())
    # self.set_height(parent.get_height())
    # print("H: ",parent.get_height()," ",self.get_height())
    # self.set_pos(0, 0)
  ...
  def add_label(topic)
    ...
    self.t_label.set_align(lv.ALIGN_TOP_MID)
    self.t_label.set_text(topic)
  end
